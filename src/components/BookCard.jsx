...
export default function BookCard({ book, onAddToWishlist, onAskAssistant }) {
  ...
  return (
    <article className="surface overflow-hidden">
      <div className="h-48 bg-gradient-to-br from-amber-200 via-orange-200 to-rose-200 p-5">
        <div className="rounded-full bg-white/80 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-bronze">
